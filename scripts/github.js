...
(function() {
  ...
  module.exports = function(robot) {
    robot.router.post("/github/webhook", function(req, res) {
      var event_type, isCorrectSignature, signature, tweet, tweetForIssues, tweetForPullRequest;
      ...
      if (!isCorrectSignature(signature, req.body)) {
